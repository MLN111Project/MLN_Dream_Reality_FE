export default {
  ...
  chart: {
    ...
    subtitle: 'Theo dõi đam mê suy giảm và căng thẳng gia tăng khi hệ thống gây áp lực',
    passion: 'Đam mê',
    stress: 'Căng thẳng',
    creativity: 'Sáng tạo',
  },
  ...
  landing: {
    ...
    theoryRelationsParen:
      '(lương bổng, quản lý độc hại, môi trường kìm hãm).',
  ...
  ending: {
    ...
    marxistMid:
      '— tài năng, đam mê và sáng tạo — bị định hình bởi',
    marxistEnd:
  ...
  careers: {
    ...
    filmmaker: { title: 'Nhà làm phim', tagline: 'Kể những câu chuyện thế giới cần' },
    artist: { title: 'Nghệ sĩ', tagline: 'Sáng tạo điều không thể đo lường' },
    developer: {
      title: 'Lập trình viên mã nguồn mở',
      tagline: 'Xây dựng cho mọi người, tự do',
    },
    designer: { title: 'Nhà thiết kế', tagline: 'Thiết kế trải nghiệm có ý nghĩa' },
    translator: { title: 'Phiên dịch viên', tagline: 'Kết nối thế giới bằng ngôn ngữ' },
    creator: { title: 'Người sáng tạo nội dung', tagline: 'Tiếng nói của bạn, nền tảng của bạn' },
    founder: {
      title: 'Nhà sáng lập startup',
  ...
  stages: {
    ...
    intern: { title: 'Thực tập sinh', subtitle: 'Lần đầu chạm vào thế giới thực' },
  ...
  events: {
    ...
    y1a: {
      ...
      choices: ['Cố gắng — văn hóa "hustle"', 'Nghỉ để chăm sóc sức khỏe tinh thần'],
    },
    y1b: {
      title: 'AI thay thế việc làm',
      narrative:
        'Tiêu đề báo chí: "AI sẽ thay thế nghề của bạn." Nỗi sợ lan khắp văn phòng như khói.',
      choices: ['Học công cụ mới cấp tốc', 'Đặt câu hỏi về hệ thống, không phải bản thân'],
    },
    y1c: {
  ...
  endings: {
    ...
    systemChanger: {
      ...
      quote: 'Một người không sửa được tất cả. Nhưng một người có thể bắt đầu tất cả.',
      description:
